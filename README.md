# Foodpanda Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Foodpanda Trademarks Logo. They did not publish any trademark guideline left
alone supplying proper material files. Its provided files for referencing was a
rasterized PNG images which are very unfeasible when it comes to website
...
`webp`, `avif`, etc). Hence, a re-draw is required.

This project re-draws Foodpanda Trademarks Logo specifically for 1200x1200 size.
...
Since Foodpanda did not supply any trademark engineering specification, **it is
assumed standard trademarks laws applied to avoid any unwanted legal
implications**. You should also refer the the following websites for their
sourcing:

* https://www.foodpanda.com/foodpanda-logos

While not specified by Foodpanda, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Foodpanda Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-foodpanda-1200x1200
UUID: F84AFFF8-6F6B-49F9-BB54-2ED7B614A0EE
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-01
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-foodpanda-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH FOODPANDA TRADEMARK REQUIREMENTS**.
>
